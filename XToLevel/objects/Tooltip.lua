         ...
         then
            ...
            if addLine ~= false then
                ...
                if type(required) == "number" and required > 0 then
                    ...
                    GameTooltip:AddLine(
                        "|cFFAAAAAANeeded to level: |r " .. required,
                        (r or 1.0),
                        (g or 1.0),
                        (b or 1.0)
                    )
...
function XToLevel.Tooltip:AddKills()
    GameTooltip:AddDoubleLine(
        " " .. L["Kills"] .. ":",
        XToLevel.Lib:NumberFormat(XToLevel.Player:GetAverageKillsRemaining()) ..
            " @ " .. XToLevel.Lib:NumberFormat(XToLevel.Lib:round(XToLevel.Player:GetAverageKillXP(), 0)) .. " xp",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
        self.dataColor.r,
...
function XToLevel.Tooltip:AddKillRange()
    ...
    GameTooltip:AddDoubleLine(
        " " .. L["Average"] .. ":",
        XToLevel.Lib:NumberFormat(XToLevel.Player:GetKillsRequired(range.average)) ..
            " @ " .. XToLevel.Lib:NumberFormat(XToLevel.Lib:round(range.average, 0)) .. " xp",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
        self.dataColor.r,
    ...
    GameTooltip:AddDoubleLine(
        " " .. L["Min"] .. ":",
        XToLevel.Lib:NumberFormat(XToLevel.Player:GetKillsRequired(range.high)) ..
            " @ " .. XToLevel.Lib:NumberFormat(XToLevel.Lib:round(range.high, 0)) .. " xp",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
        self.dataColor.r,
    ...
    GameTooltip:AddDoubleLine(
        " " .. L["Max"] .. ":",
        XToLevel.Lib:NumberFormat(XToLevel.Player:GetKillsRequired(range.low)) ..
            " @ " .. XToLevel.Lib:NumberFormat(XToLevel.Lib:round(range.low, 0)) .. " xp",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
        self.dataColor.r,
    ...
    GameTooltip:AddDoubleLine(
        " " .. L["XP Rested"] .. ": ",
        XToLevel.Lib:NumberFormat(XToLevel.Player:IsRested() or 0) .. " xp",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
        self.dataColor.r,
...
function XToLevel.Tooltip:AddQuests()
    GameTooltip:AddDoubleLine(
        " " .. L["Quests"] .. ":",
        XToLevel.Lib:NumberFormat(XToLevel.Player:GetAverageQuestsRemaining()) ..
            " @ " .. XToLevel.Lib:NumberFormat(XToLevel.Lib:round(XToLevel.Player:GetAverageQuestXP(), 0)) .. " xp",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
        self.dataColor.r,
...
function XToLevel.Tooltip:AddQuestRange()
    ...
    GameTooltip:AddDoubleLine(
        " " .. L["Average"] .. ":",
        XToLevel.Lib:NumberFormat(XToLevel.Player:GetQuestsRequired(range.average)) ..
            " @ " .. XToLevel.Lib:NumberFormat(XToLevel.Lib:round(range.average, 0)) .. " xp",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
    ...
    GameTooltip:AddDoubleLine(
        " " .. L["Min"] .. ":",
        XToLevel.Lib:NumberFormat(XToLevel.Player:GetQuestsRequired(range.high)) ..
            " @ " .. XToLevel.Lib:NumberFormat(XToLevel.Lib:round(range.high, 0)) .. " xp",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
    ...
    GameTooltip:AddDoubleLine(
        " " .. L["Max"] .. ":",
        XToLevel.Lib:NumberFormat(XToLevel.Player:GetQuestsRequired(range.low)) ..
            " @ " .. XToLevel.Lib:NumberFormat(XToLevel.Lib:round(range.low, 0)) .. " xp",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
...
function XToLevel.Tooltip:AddPetBattleRange()
    ...
    GameTooltip:AddDoubleLine(
        " " .. L["Average"] .. ":",
        XToLevel.Lib:NumberFormat(XToLevel.Player:GetPetBattlesRequired(range.average)) ..
            " @ " .. XToLevel.Lib:NumberFormat(XToLevel.Lib:round(range.average, 0)) .. " xp",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
    ...
    GameTooltip:AddDoubleLine(
        " " .. L["Min"] .. ":",
        XToLevel.Lib:NumberFormat(XToLevel.Player:GetPetBattlesRequired(range.high)) ..
            " @ " .. XToLevel.Lib:NumberFormat(XToLevel.Lib:round(range.high, 0)) .. " xp",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
    ...
    GameTooltip:AddDoubleLine(
        " " .. L["Max"] .. ":",
        XToLevel.Lib:NumberFormat(XToLevel.Player:GetPetBattlesRequired(range.low)) ..
            " @ " .. XToLevel.Lib:NumberFormat(XToLevel.Lib:round(range.low, 0)) .. " xp",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
...
function XToLevel.Tooltip:AddDungeonInfo()
    GameTooltip:AddDoubleLine(
        " " .. L["Dungeons"] .. ":",
        XToLevel.Lib:NumberFormat(XToLevel.Player:GetAverageDungeonsRemaining()) ..
            " @ " .. XToLevel.Lib:NumberFormat(XToLevel.Lib:round(XToLevel.Player:GetAverageDungeonXP(), 0)) .. " xp",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
        self.dataColor.r,
...
function XToLevel.Tooltip:AddDungeons()
    if (#XToLevel.db.char.data.dungeonList) > 0 then
        ...
        GameTooltip:AddDoubleLine(
            " " .. L["Kills"] .. ": ",
            XToLevel.Lib:NumberFormat(latestData.killCount) ..
                " @ " .. XToLevel.Lib:NumberFormat(latestData.xpPerKill) .. " xp",
            self.labelColor.r,
            self.labelColor.g,
            self.labelColor.b,
            self.dataColor.r,
        ...
        if latestData.rested > 0 then
            ...
            GameTooltip:AddDoubleLine(
                " " .. L["Total XP"] .. ": ",
                XToLevel.Lib:NumberFormat(total) ..
                    " (" .. XToLevel.Lib:NumberFormat(latestData.rested) .. " " .. L["XP Rested"] .. ")",
                self.labelColor.r,
                self.labelColor.g,
                self.labelColor.b,
                self.dataColor.r,
            ...
            GameTooltip:AddDoubleLine(
                " " .. L["Total XP"] .. ": ",
                XToLevel.Lib:NumberFormat(latestData.totalXP),
                self.labelColor.r,
                self.labelColor.g,
                self.labelColor.b,
                self.dataColor.r,
...
function XToLevel.Tooltip:AddExperience()
    ...
    GameTooltip:AddDoubleLine(
        " " .. L["XP Progress"] .. ": ",
        XToLevel.Lib:ShrinkNumber(UnitXP("player")) ..
            " / " .. XToLevel.Lib:ShrinkNumber(UnitXPMax("player")) .. " [" .. tostring(xpProgress) .. "%" .. "]",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
        self.dataColor.r,
    ...
    GameTooltip:AddDoubleLine(
        " " .. L["XP Rested"] .. ": ",
        XToLevel.Lib:ShrinkNumber(XToLevel.Player:IsRested() or 0) ..
            " [" .. XToLevel.Lib:round(XToLevel.Player:GetRestedPercentage(1)) .. "%]",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
        self.dataColor.r,
    ...
    GameTooltip:AddDoubleLine(
        " " .. L["Quest XP Required"] .. ": ",
        XToLevel.Lib:NumberFormat(xpNeededTotal) .. " xp",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
        self.dataColor.r,
    ...
    GameTooltip:AddDoubleLine(
        " " .. L["Kill XP Required"] .. ": ",
        XToLevel.Lib:NumberFormat(xpNeededActual) .. " xp",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
        self.dataColor.r,
...
function XToLevel.Tooltip:AddBattlegroundInfo()
    GameTooltip:AddDoubleLine(
        " " .. L["Battles"] .. ":",
        XToLevel.Lib:NumberFormat(XToLevel.Player:GetAverageBGsRemaining() or 0) ..
            " @ " .. XToLevel.Lib:NumberFormat(XToLevel.Lib:round(XToLevel.Player:GetAverageBGXP(), 0)) .. " xp",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
        self.dataColor.r,
    ...
    GameTooltip:AddDoubleLine(
        " " .. L["Objectives"] .. ":",
        XToLevel.Lib:NumberFormat(XToLevel.Player:GetAverageBGObjectivesRemaining() or 0) ..
            " @ " ..
                XToLevel.Lib:NumberFormat(XToLevel.Lib:round(XToLevel.Player:GetAverageBGObjectiveXP(), 0)) .. " xp",
        self.labelColor.r,
        self.labelColor.g,
        self.labelColor.b,
        self.dataColor.r,
...
function XToLevel.Tooltip:AddBattles()
    ...
    if bgs ~= nil and (#XToLevel.db.char.data.bgList) > 0 then
        ...
        if latestData ~= nil then
            ...
            GameTooltip:AddDoubleLine(
                " " .. L["Objectives"] .. ": ",
                XToLevel.Lib:NumberFormat(latestData.objCount) ..
                    " @ " .. XToLevel.Lib:NumberFormat(latestData.xpPerObj) .. " xp",
                self.labelColor.r,
                self.labelColor.g,
                self.labelColor.b,
                self.dataColor.r,
...
function XToLevel.Tooltip:AddTimerDetailes(mininmal)
    if XToLevel.db.profile.timer.enabled and XToLevel.Player.level < XToLevel.Player:GetMaxLevel() then
        ...
        GameTooltip:AddDoubleLine(
            " " .. L["Total XP"] .. ": ",
            XToLevel.Lib:NumberFormat(totalXP),
            self.labelColor.r,
            self.labelColor.g,
            self.labelColor.b,
            self.dataColor.r,
        ...
        GameTooltip:AddDoubleLine(
            " " .. L["XP per hour"] .. ": ",
            XToLevel.Lib:NumberFormat(xpPerHour),
            self.labelColor.r,
            self.labelColor.g,
            self.labelColor.b,
            self.dataColor.r,
        ...
        GameTooltip:AddDoubleLine(
            " " .. L["XP Needed"] .. ": ",
            XToLevel.Lib:NumberFormat(XToLevel.Player.maxXP - XToLevel.Player.currentXP),
            self.labelColor.r,
            self.labelColor.g,
            self.labelColor.b,
            self.dataColor.r,
            ...
            if #items > 0 then
                ...
                for i, item in ipairs(items) do
                    ...
                    if type(required) == "number" and required > 0 then
                        ...
                        GameTooltip:AddDoubleLine(
                            " - " .. item,
                            required .. " @ " .. tostring(avgxpFormatted) .. " xp",
                            self.labelColor.r,
                            self.labelColor.g,
                            self.labelColor.b,
                            self.dataColor.r,
