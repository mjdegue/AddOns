                ...
                args = {
                    ...
                    infoVersion = {
                        ...
                        name = "|cFFFFAA00" ..
                            L["Version"] ..
                                ":|r |cFF00FF00" ..
                                    tostring(XToLevel.version) ..
                                        "|r |cFFAAFFAA(" .. tostring(XToLevel.releaseDate) .. ")"
                    },
                    infoAuthor = {
                        order = 3,
                        type = "description",
                    ...
                    infoWebsite = {
                        ...
                        type = "description",
                        name = "|cFFFFAA00" ..
                            L["Website"] .. ":|r |cFFFFFFFF" .. "http://wow.curseforge.com/addons/xto-level/"
                    },
                    infoCategory = {
                        order = 6,
                        type = "description",
                        name = "|cFFFFAA00" ..
                            L["Category"] .. ":|r |cFFFFFFFF" .. "Quests & Leveling, Battlegrounds, Dungeons."
                    },
                    infoLicense = {
                        order = 7,
                        type = "description",
            ...
            General = {
                ...
                args = {
                    ...
                    debugEnabled = {
                        ...
                        get = function(info)
                            return XToLevel.db.profile.general.showDebug
                        end,
                        set = function(info, value)
                            XToLevel.db.profile.general.showDebug = value
                        end
                    },
                    rafEnabled = {
                        order = 4,
                        ...
                        get = function(info)
                            return XToLevel.db.profile.general.rafEnabled
                        end,
                        set = function(info, value)
                            XToLevel.db.profile.general.rafEnabled = value
                        end
                    }
                }
            },
            Messages = {
                ...
                args = {
                    ...
                    playerFloating = {
                        ...
                        get = function(info)
                            return XToLevel.db.profile.messages.playerFloating
                        end,
                        set = function(info, value)
                            XToLevel.db.profile.messages.playerFloating = value
                        end
                    },
                    playerChat = {
                        order = 2,
                        ...
                        name = L["Show In Chat"],
                        get = function(info)
                            return XToLevel.db.profile.messages.playerChat
                        end,
                        set = function(info, value)
                            XToLevel.db.profile.messages.playerChat = value
                        end
                    },
                    playerBG = {
                        order = 3,
                        ...
                        get = function(info)
                            return XToLevel.db.profile.messages.bgObjectives
                        end,
                        set = function(info, value)
                            XToLevel.db.profile.messages.bgObjectives = value
                        end
                    },
                    colorsHeader = {
                        order = 4,
                    ...
                    colorKills = {
                        ...
                        hasAlpha = true,
                        get = function(info)
                            return unpack(XToLevel.db.profile.messages.colors.playerKill)
                        end,
                        set = function(info, r, g, b, a)
                            XToLevel.db.profile.messages.colors.playerKill = {r, g, b, a}
                        end
                    },
                    colorQuests = {
                        order = 6,
                        ...
                        hasAlpha = true,
                        get = function(info)
                            return unpack(XToLevel.db.profile.messages.colors.playerQuest)
                        end,
                        set = function(info, r, g, b, a)
                            XToLevel.db.profile.messages.colors.playerQuest = {r, g, b, a}
                        end
                    },
                    colorDungeons = {
                        order = 7,
                        ...
                        hasAlpha = true,
                        get = function(info)
                            return unpack(XToLevel.db.profile.messages.colors.playerDungeon)
                        end,
                        set = function(info, r, g, b, a)
                            XToLevel.db.profile.messages.colors.playerDungeon = {r, g, b, a}
                        end
                    },
                    colorBattles = {
                        order = 8,
                        ...
                        hasAlpha = true,
                        get = function(info)
                            return unpack(XToLevel.db.profile.messages.colors.playerBattleground)
                        end,
                        set = function(info, r, g, b, a)
                            XToLevel.db.profile.messages.colors.playerBattleground = {r, g, b, a}
                        end
                    },
                    colorLevelup = {
                        order = 9,
                        ...
                        hasAlpha = true,
                        get = function(info)
                            return unpack(XToLevel.db.profile.messages.colors.playerLevel)
                        end,
                        set = function(info, r, g, b, a)
                            XToLevel.db.profile.messages.colors.playerLevel = {r, g, b, a}
                        end
                    },
                    colorResetHeader = {
                        order = 10,
                    ...
                    colorResetBtn = {
                        ...
                        name = L["Color Reset"],
                        func = function()
                            StaticPopup_Show("XToLevelConfig_MessageColorsReset")
                        end
                    }
                }
            },
            Window = {
                ...
                args = {
                    ...
                    windowScale = {
                        ...
                        width = "full",
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.scale
                        end,
                        set = function(info, value)
                    ...
                    classicShowBackdrop = {
                        ...
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.backdrop
                        end,
                        set = function(info, value)
                    ...
                    classicShowHeader = {
                        ...
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.header
                        end,
                        set = function(info, value)
                    ...
                    classicShowVerbose = {
                        ...
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.verbose
                        end,
                        set = function(info, value)
                    ...
                    classicShowColored = {
                        ...
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.colorText
                        end,
                        set = function(info, value)
                    ...
                    blockyVerticalAlign = {
                        ...
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.orientation == "v"
                        end,
                        set = function(info, value)
                    ...
                    behaviorLocked = {
                        ...
                        get = function(info)
                            return not XToLevel.db.profile.general.allowDrag
                        end,
                        set = function(info, value)
                    ...
                    behaviorAllowClick = {
                        ...
                        get = function(info)
                            return XToLevel.db.profile.general.allowSettingsClick
                        end,
                        set = function(info, value)
                    ...
                    behaviorShowTooltip = {
                        ...
                        name = L["Show Tooltip"],
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.tooltip
                        end,
                        set = function(info, value)
                    ...
                    behaviorCombineTooltip = {
                        ...
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.combineTooltip
                        end,
                        set = function(info, value)
                    ...
                    behaviorProgressAsBars = {
                        ...
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.progressAsBars
                        end,
                        set = function(info, value)
                    ...
                    dataKills = {
                        ...
                        name = L["Kills"],
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.playerKills
                        end,
                        set = function(info, value)
                    ...
                    dataQuests = {
                        ...
                        name = L["Player Quests"],
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.playerQuests
                        end,
                        set = function(info, value)
                    ...
                    dataDungeons = {
                        ...
                        name = L["Player Dungeons"],
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.playerDungeons
                        end,
                        set = function(info, value)
                    ...
                    dataBattles = {
                        ...
                        name = L["Player Battles"],
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.playerBGs
                        end,
                        set = function(info, value)
                    ...
                    dataBattleObjectives = {
                        ...
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.playerBGOs
                        end,
                        set = function(info, value)
                    ...
                    dataProgress = {
                        ...
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.playerProgress
                        end,
                        set = function(info, value)
                    ...
                    dataTimer = {
                        ...
                        name = L["Player Timer"],
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.playerTimer
                        end,
                        set = function(info, value)
                    ...
                    dataGathering = {
                        ...
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.playerGathering
                        end,
                        set = function(info, value)
                    ...
                    dataPetBattle = {
                        ...
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.playerPetBattles
                        end,
                        set = function(info, value)
                    ...
                    dataArchaeology = {
                        ...
                        get = function(info)
                            return XToLevel.db.profile.averageDisplay.playerDigs
                        end,
                        set = function(info, value)
            ...
            LDB = {
                ...
                args = {
                    ldbEnabled = {
                        ...
                        get = function(i)
                            return XToLevel.db.profile.ldb.enabled
                        end,
                        set = function(i, v)
                    ...
                    ldbPatternInput = {
                        ...
                        multiline = true,
                        get = function(i)
                            return XToLevel.db.char.customPattern
                        end,
                        set = function(i, v)
                    ...
                    ldbShowText = {
                        ...
                        name = L["Show Text"],
                        get = function(i)
                            return XToLevel.db.profile.ldb.showText
                        end,
                        set = function(i, v)
                    ...
                    ldbShowLabel = {
                        ...
                        name = L["Show Label"],
                        get = function(i)
                            return XToLevel.db.profile.ldb.showLabel
                        end,
                        set = function(i, v)
                    ...
                    ldbShowIcon = {
                        ...
                        name = L["Show Icon"],
                        get = function(i)
                            return XToLevel.db.profile.ldb.showIcon
                        end,
                        set = function(i, v)
                    ...
                    ldbColoredText = {
                        ...
                        get = function(i)
                            return XToLevel.db.profile.ldb.allowTextColor
                        end,
                        set = function(i, v)
                    ...
                    ldbColorByXp = {
                        ...
                        name = L["Color By XP"],
                        get = function(i)
                            return XToLevel.db.profile.ldb.text.colorValues
                        end,
                        set = function(i, v)
                    ...
                    ldbProgressAsBars = {
                        ...
                        get = function(i)
                            return XToLevel.db.profile.ldb.text.xpAsBars
                        end,
                        set = function(i, v)
                    ...
                    ldbShowVerbose = {
                        ...
                        name = L["Show Verbose"],
                        get = function(i)
                            return XToLevel.db.profile.ldb.text.verbose
                        end,
                        set = function(i, v)
                    ...
                    ldbShowXpRemaining = {
                        ...
                        get = function(i)
                            return XToLevel.db.profile.ldb.text.xpCountdown
                        end,
                        set = function(i, v)
                    ...
                    ldbShortenXP = {
                        ...
                        get = function(i)
                            return XToLevel.db.profile.ldb.text.xpnumFormat
                        end,
                        set = function(i, v)
                    ...
                    ldbDataKills = {
                        ...
                        name = L["Player Kills"],
                        get = function(i)
                            return XToLevel.db.profile.ldb.text.kills
                        end,
                        set = function(i, v)
                    ...
                    ldbDataQuests = {
                        ...
                        name = L["Player Quests"],
                        get = function(i)
                            return XToLevel.db.profile.ldb.text.quests
                        end,
                        set = function(i, v)
                    ...
                    ldbDataDungeons = {
                        ...
                        name = L["Player Dungeons"],
                        get = function(i)
                            return XToLevel.db.profile.ldb.text.dungeons
                        end,
                        set = function(i, v)
                    ...
                    ldbDataBattles = {
                        ...
                        name = L["Player Battles"],
                        get = function(i)
                            return XToLevel.db.profile.ldb.text.bgs
                        end,
                        set = function(i, v)
                    ...
                    ldbDataObjectives = {
                        ...
                        name = L["Player Objectives"],
                        get = function(i)
                            return XToLevel.db.profile.ldb.text.bgo
                        end,
                        set = function(i, v)
                    ...
                    ldbDataProgress = {
                        ...
                        name = L["Player Progress"],
                        get = function(i)
                            return XToLevel.db.profile.ldb.text.xp
                        end,
                        set = function(i, v)
                    ...
                    ldbDataExperience = {
                        ...
                        get = function(i)
                            return XToLevel.db.profile.ldb.text.xpnum
                        end,
                        set = function(i, v)
                    ...
                    ldbDataGathering = {
                        ...
                        name = L["Gathering"],
                        get = function(i)
                            return XToLevel.db.profile.ldb.text.gather
                        end,
                        set = function(i, v)
                    ...
                    ldbDataArchaeology = {
                        ...
                        name = L["Archaeology"],
                        get = function(i)
                            return XToLevel.db.profile.ldb.text.digs
                        end,
                        set = function(i, v)
            ...
            Data = {
                ...
                args = {
                    ...
                    dataRangeKills = {
                        ...
                        step = 1,
                        get = function()
                            return XToLevel.db.profile.averageDisplay.playerKillListLength
                        end,
                        set = function(i, v)
                            XToLevel.Player:SetKillAverageLength(v)
                        end
                    },
                    dataRangeQuests = {
                        order = 3,
                        ...
                        step = 1,
                        get = function()
                            return XToLevel.db.profile.averageDisplay.playerQuestListLength
                        end,
                        set = function(i, v)
                            XToLevel.Player:SetQuestAverageLength(v)
                        end
                    },
                    dataRangePetBattles = {
                        order = 4,
                        ...
                        step = 1,
                        get = function()
                            return XToLevel.db.profile.averageDisplay.playerPetBattleListLength
                        end,
                        set = function(i, v)
                            XToLevel.Player:SetPetBattleAverageLength(v)
                        end
                    },
                    dataRangeBattles = {
                        order = 5,
                        ...
                        step = 1,
                        get = function()
                            return XToLevel.db.profile.averageDisplay.playerBGListLength
                        end,
                        set = function(i, v)
                            XToLevel.Player:SetBattleAverageLength(v)
                        end
                    },
                    dataRangeObjectives = {
                        order = 6,
                        ...
                        step = 1,
                        get = function()
                            return XToLevel.db.profile.averageDisplay.playerBGOListLength
                        end,
                        set = function(i, v)
                            XToLevel.Player:SetObjectiveAverageLength(v)
                        end
                    },
                    dataRangeDungeons = {
                        order = 7,
                        ...
                        step = 1,
                        get = function()
                            return XToLevel.db.profile.averageDisplay.playerDungeonListLength
                        end,
                        set = function(i, v)
                            XToLevel.Player:SetDungeonAverageLength(v)
                        end
                    },
                    dataClearHeader = {
                        order = 8,
                    ...
                    dataClearKills = {
                        ...
                        func = function()
                            StaticPopup_Show("XToLevelConfig_ResetPlayerKills")
                        end
                    },
                    dataClearQuests = {
                        order = 11,
                        ...
                        func = function()
                            StaticPopup_Show("XToLevelConfig_ResetPlayerQuests")
                        end
                    },
                    dataClearDungeons = {
                        order = 12,
                        ...
                        func = function()
                            StaticPopup_Show("XToLevelConfig_ResetDungeons")
                        end
                    },
                    dataClearBattles = {
                        order = 13,
                        ...
                        func = function()
                            StaticPopup_Show("XToLevelConfig_ResetBattles")
                        end
                    },
                    dataClearPetBattles = {
                        order = 14,
                        ...
                        func = function()
                            StaticPopup_Show("XToLevelConfig_ResetPetBattles")
                        end
                    },
                    dataClearGathering = {
                        order = 15,
                        ...
                        func = function()
                            StaticPopup_Show("XToLevelConfig_ResetGathering")
                        end
                    }
                }
            },
            Tooltip = {
                ...
                args = {
                    ...
                    playerDetails = {
                        ...
                        get = function(i)
                            return XToLevel.db.profile.ldb.tooltip.showDetails
                        end,
                        set = function(i, v)
                            XToLevel.db.profile.ldb.tooltip.showDetails = v
                        end
                    },
                    playerExperience = {
                        order = 3,
                        ...
                        get = function(i)
                            return XToLevel.db.profile.ldb.tooltip.showExperience
                        end,
                        set = function(i, v)
                            XToLevel.db.profile.ldb.tooltip.showExperience = v
                        end
                    },
                    battleInfo = {
                        order = 4,
                        ...
                        get = function(i)
                            return XToLevel.db.profile.ldb.tooltip.showBGInfo
                        end,
                        set = function(i, v)
                            XToLevel.db.profile.ldb.tooltip.showBGInfo = v
                        end
                    },
                    dungeonInfo = {
                        order = 5,
                        ...
                        get = function(i)
                            return XToLevel.db.profile.ldb.tooltip.showDungeonInfo
                        end,
                        set = function(i, v)
                            XToLevel.db.profile.ldb.tooltip.showDungeonInfo = v
                        end
                    },
                    gatheringInfo = {
                        order = 6,
                        ...
                        get = function(i)
                            return XToLevel.db.profile.ldb.tooltip.showGatheringInfo
                        end,
                        set = function(i, v)
                            XToLevel.db.profile.ldb.tooltip.showGatheringInfo = v
                        end
                    },
                    archaeologyDetails = {
                        order = 7,
                        ...
                        get = function(i)
                            return XToLevel.db.profile.ldb.tooltip.showArchaeologyInfo
                        end,
                        set = function(i, v)
                            XToLevel.db.profile.ldb.tooltip.showArchaeologyInfo = v
                        end
                    },
                    timerDetails = {
                        order = 8,
                        ...
                        get = function(i)
                            return XToLevel.db.profile.ldb.tooltip.showTimerInfo
                        end,
                        set = function(i, v)
                            XToLevel.db.profile.ldb.tooltip.showTimerInfo = v
                        end
                    },
                    miscHeader = {
                        order = 9,
                    ...
                    npcTooltipData = {
                        ...
                        get = function(i)
                            return XToLevel.db.profile.general.showNpcTooltipData
                        end,
                        set = function(i, v)
                            XToLevel.db.profile.general.showNpcTooltipData = v
                        end
                    }
                }
            },
            Timer = {
                ...
                args = {
                    enableTimer = {
                        ...
                        name = L["Enable Timer"],
                        get = function()
                            return XToLevel.db.profile.timer.enabled
                        end,
                        set = "SetTimerEnabled"
                    },
                    modeHeader = {
                    ...
                    modeSelect = {
                        ...
                        get = function()
                            return XToLevel.db.profile.timer.mode
                        end,
                        set = function(i, v)
                            XToLevel.db.profile.timer.mode = v
                        end
                    },
                    timerReset = {
                        order = 3,
                    ...
                    timoutRange = {
                        ...
                        step = 1,
                        get = function()
                            return XToLevel.db.profile.timer.sessionDataTimeout
                        end,
                        set = function(i, v)
                            XToLevel.db.profile.timer.sessionDataTimeout = v
                        end
                    }
                }
            }
...
function XToLevel.Config:SetTimerEnabled(info, value)
    ...
    if XToLevel.db.profile.timer.enabled then
        XToLevel.Player.timerHandler =
            XToLevel.timer:ScheduleRepeatingTimer(XToLevel.Player.TriggerTimerUpdate, XToLevel.Player.xpPerSecTimeout)
    else
...
function XToLevel.Config:Verify()
    ...
    if
        type(XToLevel.db.char.data.timer.lastUpdated) ~= "number" or
            GetTime() - XToLevel.db.char.data.timer.lastUpdated > (XToLevel.db.profile.timer.sessionDataTimeout * 60) or
            GetTime() - XToLevel.db.char.data.timer.start <= 0
     then
        XToLevel.db.char.data.timer.start = GetTime()
        XToLevel.db.char.data.timer.total = 0
